        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input type="file" accept="image/*" onChange={handleImageUpload}
              className="w-full px-4 py-2 bg-gray-50 border border-gray-200 rounded-xl text-gray-800 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary" />
            {form.cover_image_url && <p className="text-green-600 text-sm mt-1 font-medium">✓ Image uploaded</p>}
          </div>
          <div>
            <label className="block text-gray-700 font-medium mb-2">Book File (PDF/EPUB)</label>
            <input type="file" accept=".pdf,.epub" onChange={handlePDFUpload}
              className="w-full px-4 py-2 bg-gray-50 border border-gray-200 rounded-xl text-gray-800 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary" />
            {form.content_url && <p className="text-green-600 text-sm mt-1 font-medium">✓ File uploaded</p>}
          </div>
