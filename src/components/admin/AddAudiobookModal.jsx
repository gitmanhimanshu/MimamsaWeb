    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-primary text-white p-4 flex justify-between items-center rounded-t-lg">
          <h2 className="text-xl font-bold">Add Audiobook</h2>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-gray-700 font-semibold mb-2">Narrator</label>
          ...
          <div>
            <label className="block text-gray-700 font-semibold mb-2">Audio URL *</label>
          ...
          <div className="border-2 border-primary rounded-lg p-4 bg-orange-50">
            <label className="flex items-center space-x-2 cursor-pointer">
              <input type="checkbox" name="is_paid" checked={formData.is_paid} onChange={handleChange}
                className="w-5 h-5 text-primary" />
              <span className="text-gray-700 font-semibold">Paid Content</span>
            </label>
            {formData.is_paid && (
              <div className="mt-3">
